...
diff -ENwbur $2/Sphere/Box/Original/Start_stop/ $2/Sphere/Box/New/Start_stop/ | sed '/Binary\ files\ /d' > SphereBoxDiff.txt
...
diff -ENwbur $2/Sphere/Cone/Original/Start_stop/ $2/Sphere/Cone/New/Start_stop/ | sed '/Binary\ files\ /d'> SphereConeDiff.txt
...
diff -ENwbur $2/Body/Box/Original/Start_stop/ $2/Body/Box/New/Start_stop/ | sed '/Binary\ files\ /d'> BodyBoxDiff.txt
diff BodyBoxNew.txt BodyBoxOriginal.txt > BodyBoxTiming.txt
echo BodyBoxNew finished
$1 -d $2/Body/Cone/New/ > BodyConeNew.txt
diff -ENwbur $2/Body/Cone/Original/Start_stop/ $2/Body/Cone/New/Start_stop/ | sed '/Binary\ files\ /d'> BodyConeDiff.txt
diff BodyConeNew.txt BodyConeOriginal.txt > BodyConeTiming.txt
echo BodyConeNew finished
$1 -d $2/Mix/Box/New/ > MixBoxNew.txt
diff -ENwbur $2/Mix/Box/Original/Start_stop/ $2/Mix/Box/New/Start_stop/ | sed '/Binary\ files\ /d'> MixBoxDiff.txt
diff MixBoxNew.txt MixBoxOriginal.txt > MixBoxTiming.txt
echo MixBoxNew finished
$1 -d $2/Mix/Cone/New/ > MixConeNew.txt
diff -ENwbur $2/Mix/Cone/Original/Start_stop/ $2/Mix/Cone/New/Start_stop/ | sed '/Binary\ files\ /d'> MixConeDiff.txt
...
diff -ENwbur $2/MasterSolid/Original/Start_stop/ $2/MasterSolid/New/Start_stop/ | sed '/Binary\ files\ /d'> MasterSolidDiff.txt
