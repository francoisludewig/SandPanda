...
class Compaction {
public:
	static void Secousse(std::vector<Plan> & pl,std::vector<PlanR> & plr,std::vector<Cone> & co,int Npl, int Nplr, int Nco, double Gamma, double f, Data & dat) noexcept;
	
	static void Relaxation(std::vector<Plan> & pl,std::vector<PlanR> & plr,std::vector<Cone> & co,int Npl, int Nplr, int Nco, double Gamma, double f, Data & dat) noexcept;
	...
	static int RunOMP(int & Npl,int & Nplr,int & Nco,int & Nelb,int & Nsph,int & Nsph0,int & Nbd,int & Nhb,int & Nct,int & Ncta,int & Nctb,int & Nctc,
