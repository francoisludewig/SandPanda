...
std::shared_ptr<Solids> SolidBuilder::BuildFromExport(Option& opt) noexcept {
	auto solids = std::shared_ptr<Solids>(new Solids());
...
std::shared_ptr<Solids> SolidBuilder::BuildFromStart_Stop(Option& opt) noexcept {
	auto solids = std::shared_ptr<Solids>(new Solids());
...
void SolidBuilder::LoadBodySpecies(Option &opt, std::shared_ptr<Solids>& solids) noexcept {
...
void SolidBuilder::WriteStart_Stop(Option &opt, std::shared_ptr<Solids>& solids, int ntp) noexcept {
