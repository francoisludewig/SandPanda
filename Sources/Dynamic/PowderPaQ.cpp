...
void
PowderPaQ::PowderPaQsecousseUpward(vector<Plan> &pl, vector<PlanR> &plr, vector<Cone> &co, int Npl, int Nplr, int Nco,
                                   Data &dat, double PQheight, double PQVel) noexcept {
    int i;
    for (i = 0; i < Npl; i++) {
...
void
PowderPaQ::PowderPaQsecousseDownward(vector<Plan> &pl, vector<PlanR> &plr, vector<Cone> &co, int Npl, int Nplr, int Nco,
                                     Data &dat, double PQheight) noexcept {
    int i;
...
void PowderPaQ::PowderPaQrelaxation(vector<Plan> &pl, vector<PlanR> &plr, vector<Cone> &co, int Npl, int Nplr, int Nco,
                                    Data &dat, double t, double PQheight, double PQVel) noexcept {
    int i;
    for (i = 0; i < Npl; i++) {
        pl[i].SetVz(0, 0, 0, 0);
...
int
PowderPaQ::PowderPaQRun(int &Npl, int &Nplr, int &Nco, int &Nelb, int &Nsph, int &Nsph0, int &Nbd, int &Nhb, int &Nct,
                        ...
                        Sphere *cell[], int &Ntp, char *name, bool record, int ntpi, int ntpf, int Nthreshold,
                        double PQheight, double PQVel) noexcept {
    record = 0;
    for (int nt = ntpi; nt <= ntpf; nt++) {
        //Secousse
        PowderPaQsecousseUpward(pl, plr, co, Npl, Nplr, Nco, dat, PQheight, PQVel);
        Ntp = Evolution::Evolve(Npl, Nplr, Nco, Nelb, Nsph, Nsph0, Nbd, Nhb, Nct, pl, plr, co, elb, sph, bd, hb, ct,
                                dat, gf, cell, Ntp, name, record, Nthreshold, false);
...
int
PowderPaQ::PowderPaQOMP(int &Npl, int &Nplr, int &Nco, int &Nelb, int &Nsph, int &Nsph0, int &Nbd, int &Nhb, int &Nct,
                        int &Ncta, int &Nctb, int &Nctc,
                        vector<Plan> &pl, vector<PlanR> &plr, vector<Cone> &co, vector<Elbow> &elb, vector<Sphere> &sph,
                        vector<Body> &bd, vector<HollowBall> &hb, Contact *ct, Contact *cta, Contact *ctb, Contact *ctc,
                        Data &dat, Gravity &gf,
                        Sphere *cell[], int &Ntp, char *name, bool record, int ntpi, int ntpf, int Nthreshold,
                        double PQheight, double PQVel) noexcept {
    record = 0;
    for (int nt = ntpi; nt <= ntpf; nt++) {
        ...
        PowderPaQsecousseUpward(pl, plr, co, Npl, Nplr, Nco, dat, PQheight, PQVel);
        printf("Total = %e\n", dat.Total);
        Ntp = Evolution::EvolveOMP(Npl, Nplr, Nco, Nelb, Nsph, Nsph0, Nbd, Nhb, Nct, Ncta, Nctb, Nctc, pl, plr, co, elb,
                                   sph, bd, hb, ct, cta, ctb, ctc, dat, gf, cell, Ntp, name, record, Nthreshold, false);
        PowderPaQsecousseDownward(pl, plr, co, Npl, Nplr, Nco, dat, PQheight);
        printf("Total = %e\n", dat.Total);
        Ntp = Evolution::EvolveOMP(Npl, Nplr, Nco, Nelb, Nsph, Nsph0, Nbd, Nhb, Nct, Ncta, Nctb, Nctc, pl, plr, co, elb,
                                   sph, bd, hb, ct, cta, ctb, ctc, dat, gf, cell, Ntp, name, record, Nthreshold, false);
