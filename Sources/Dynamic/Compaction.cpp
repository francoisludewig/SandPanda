...
void
Compaction::Secousse(vector<Plan> &pl, vector<PlanR> &plr, vector<Cone> &co, int Npl, int Nplr, int Nco, double Gamma,
                     double f, Data &dat) noexcept {
    int i;
    double w = 2 * M_PI * f;
...
void Compaction::Relaxation(vector<Plan> &pl, vector<PlanR> &plr, vector<Cone> &co, int Npl, int Nplr, int Nco,
                            Data &dat) noexcept {
    int i;
    for (i = 0; i < Npl; i++)
        pl[i].SetVz(0, 0, 0, 0);
...
int Compaction::RunOMP(int &Npl, int &Nplr, int &Nco, int &Nelb, int &Nsph, int &Nsph0, int &Nbd, int &Nhb, int &Nct,
