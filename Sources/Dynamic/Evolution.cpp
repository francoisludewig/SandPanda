...
int Evolution::Evolve(int &Npl, int &Nplr, int &Nco, int &Nelb, int &Nsph, int &Nsph0, int &Nbd, int &Nhb, int &Nct,
    ...
    do {
        ...
        ContactDetection::sphContainer(Nsph, Npl, Nplr, Nco, Nelb, Nhb, sph, pl, plr, co, elb, hb, Nct, ct, cell,
                                       dat.Rmax);
...
int Evolution::EvolveOMP(int &Npl, int &Nplr, int &Nco, int &Nelb, int &Nsph, int &Nsph0, int &Nbd, int &Nhb, int &Nct,
    ...
    do {
        ...
        // Initialization for the time step
        ComputeForce::InitForTimeStepOMP(Nsph, Nbd, Nct, Ncta, Nctb, Nctc, Npl, Nplr, Nco, Nelb, sph, bd, ct, cta, ctb,
                                         ctc, pl, plr, co, elb);
...
#pragma omp section
                    ContactDetection::sphContact(dat.Nx / 2, dat.Nx, dat.Nx, 0, dat.Ny, dat.Ny, dat.Nz, cta, Ncta,
                                                 cell);
                }
            }
        } else {
...
#pragma omp section
                    ContactDetection::sphContact(0, dat.Nx / 2, dat.Nx, dat.Ny / 2, dat.Ny, dat.Ny, dat.Nz, cta, Ncta,
                                                 cell);
#pragma omp section
                    ContactDetection::sphContact(dat.Nx / 2, dat.Nx, dat.Nx, 0, dat.Ny / 2, dat.Ny, dat.Nz, ctb, Nctb,
                                                 cell);
#pragma omp section
                    ContactDetection::sphContact(dat.Nx / 2, dat.Nx, dat.Nx, dat.Ny / 2, dat.Ny, dat.Ny, dat.Nz, ctc,
                                                 Nctc, cell);
                }
            }
        }
        ...
        ContactDetection::sphContainerOMP(Nsph, Npl, Nplr, Nco, Nelb, Nhb, sph, pl, plr, co, elb, hb, Nct, ct, Ncta,
                                          cta, cell, dat.Rmax);
...
int Evolution::EvolveMelt(int &Npl, int &Nplr, int &Nco, int &Nelb, int &Nsph, int &Nsph0, int &Nbd, int &Nhb, int &Nct,
                          vector<Plan> &pl, vector<PlanR> &plr, vector<Cone> &co, vector<Elbow> &elb,
                          vector<Sphere> &sph, vector<Body> &bd, vector<HollowBall> &hb, Contact *ct, Data &dat,
                          Gravity &gf,
                          Sphere *cell[], int &Ntp, char *name, bool record, double vr, double delayVr,
                          int Nthreshold) noexcept {
    printf("Evolution\n");
    double dtl;
    double r0, r1;
    // Sequential Version
...
int
Evolution::EvolveMeltOMP(int &Npl, int &Nplr, int &Nco, int &Nelb, int &Nsph, int &Nsph0, int &Nbd, int &Nhb, int &Nct,
                         int &Ncta, int &Nctb, int &Nctc,
                         vector<Plan> &pl, vector<PlanR> &plr, vector<Cone> &co, vector<Elbow> &elb,
                         vector<Sphere> &sph, vector<Body> &bd, vector<HollowBall> &hb, Contact *ct, Contact *cta,
                         Contact *ctb, Contact *ctc, Data &dat, Gravity &gf,
